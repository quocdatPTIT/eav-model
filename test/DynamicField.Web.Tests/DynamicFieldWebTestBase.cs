...
{
    public abstract class DynamicFieldWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static DynamicFieldWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(DynamicFieldWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<DynamicFieldDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<DynamicFieldDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<DynamicFieldDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<DynamicFieldDbContext, Task<T>> func)
        {
            T result;
